#!/usr/bin/env python3
"""
List available tools from the Looker MCP server.
Usage: python list_tools.py
       MCP_URL=http://127.0.0.1:5001/mcp/default python list_tools.py
"""
...
MCP_URL = os.environ.get("MCP_URL", "http://127.0.0.1:5001/mcp/looker")
...
if __name__ == "__main__":
    try:
        print("Fetching available Looker MCP tools...")
        print("=" * 50)
        tools = list_tools()
        ...
        print("\nTry these endpoints:")
        print("  MCP_URL=http://127.0.0.1:5001/mcp/looker python list_tools.py")
        print("  MCP_URL=http://127.0.0.1:5001/mcp/default python list_tools.py")
        print("\nMake sure the MCP server is running with the looker toolset enabled.")
